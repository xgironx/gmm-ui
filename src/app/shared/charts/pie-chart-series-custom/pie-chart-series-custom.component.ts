...
@Component({
  selector: 'g[app-pie-chart-series-custom]',
  templateUrl: './pie-chart-series-custom.component.html',
  styleUrls: ['./pie-chart-series-custom.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})

export class PieChartSeriesCustomComponent implements OnChanges {
