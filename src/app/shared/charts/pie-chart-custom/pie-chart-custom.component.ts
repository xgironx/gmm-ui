...
@Component({
  selector: 'app-pie-chart-custom',
  templateUrl: './pie-chart-custom.component.html',
  styleUrls: ['./pie-chart-custom.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})

export class PieChartCustomComponent extends BaseChartComponent {
